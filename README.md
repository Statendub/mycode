...
Just learning python , thats why its here!

## Getting Started

Theres not much to provide here 
...
```
you probably want to intsall Python 3 ```

### Installing

Installing is straight forward but making this change to test GIT upload from console
